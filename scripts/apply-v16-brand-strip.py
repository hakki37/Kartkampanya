...
# Add the separators between bank, card program and network.
...
if count:
    ...
    print('compact logo row already changed or not found')

# Also format the detail-page logo row if v16 left it without separators.
