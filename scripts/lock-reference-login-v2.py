...
class _LoginPageState extends State<LoginPage> {
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: const LinearGradient(colors: [Color(0xFF8C7CFF), Color(0xFF5A47D6)]),
              ...
              _field(password, Icons.lock_outline_rounded, 'Şifre', obscure: obscure, suffix: IconButton(
                ...
                icon: Icon(obscure ? Icons.visibility_outlined : Icons.visibility_off_outlined, size: 17),
              )),
              if (error != null) ...[
              ...
              SizedBox(width: double.infinity, height: 50, child: FilledButton(
                ...
                style: FilledButton.styleFrom(backgroundColor: const Color(0xFF6C5CE7), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16))),
                child: Text(busy ? 'Bekleyin...' : (register ? 'Kayıt Ol' : 'Giriş Yap'), style: const TextStyle(fontWeight: FontWeight.w800)),
              )),
              ...
              SizedBox(width: double.infinity, height: 50, child: OutlinedButton(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text(googleBusy ? 'Google açılıyor...' : 'Google ile Giriş Yap', style: const TextStyle(fontSize: 13.5, fontWeight: FontWeight.w700, color: Color(0xFF1E1B3A))),
                ]),
              )),
            ],
          ),
  ...
  Widget _field(TextEditingController controller, IconData icon, String hint, {bool obscure = false, Widget? suffix}) => Container(
    ...
    child: TextField(controller: controller, obscureText: obscure, keyboardType: hint.startsWith('E-posta') ? TextInputType.emailAddress : TextInputType.text, decoration: InputDecoration(prefixIcon: Icon(icon, size: 17), suffixIcon: suffix, hintText: hint, border: InputBorder.none)),
  );
}
