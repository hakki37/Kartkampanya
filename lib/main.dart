...
class _SmartCampaignCardState extends State<SmartCampaignCard> {
  ...
  double get reward =>
      double.tryParse('${c['_reward'] ?? c['reward_amount'] ?? c['max_reward'] ?? 0}') ?? 0;

  double get minSpend =>
      double.tryParse('${c['min_spend'] ?? 0}') ?? 0;
            ...
            children: [
              ...
              Wrap(
                ...
                children: [
                  ...
                  if (rewardValue > 0) _pill(Icons.savings_outlined, '+${rewardValue.toStringAsFixed(0)} TL', Colors.amber.withOpacity(.16), Colors.orange.shade900),
                ],
              ),
              if (target != null) ...[
              ...
              Row(
                children: [
                  if (minValue > 0)
                    Text('Min. ${minValue.toStringAsFixed(0)} TL', style: const TextStyle(fontWeight: FontWeight.w700)),
                  const Spacer(),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        if (minValue > 0) _detailRow(Icons.shopping_cart_outlined, 'Minimum harcama', '${minValue.toStringAsFixed(0)} TL'),
                        if (rewardValue > 0) _detailRow(Icons.savings_outlined, 'Tahmini avantaj', '${rewardValue.toStringAsFixed(0)} TL'),
