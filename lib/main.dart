...
class _CampaignsPageState extends State<CampaignsPage> {
  ...
  Future<List<Map<String, dynamic>>> fetchCampaigns() async {
    ...
    // Genel kampanya kaydı campaigns tablosunda, banka/kart
    // kısıtları campaign_rules tablosunda tutuluyor.
    // İki tablodaki aynı id değerlerini birleştiriyoruz.
    ...
    for (final campaign in list) {
      ...
      final rule = rulesById['${campaign['id']}'];
      if (rule != null) {
        // campaign_rules daha özel kart kısıtlarını içerdiği için
        // burada banka/kart/ağ bilgilerini kampanyaya bağlıyoruz.
        for (final field in [
          'bank_name',
          'card_name',
          'network',
        ...
        if (network.isEmpty && eligible != null) {
          campaign['network'] = eligible is List
              ? eligible.join('/')
              : '$eligible';
        }
      }
